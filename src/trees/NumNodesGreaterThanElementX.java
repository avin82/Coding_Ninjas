...
public class NumNodesGreaterThanElementX {
	...
	public static void main(String[] args) {
		 ...
		 */
		Scanner scanner = new Scanner(System.in);
		System.out.print("Enter a number say x to find the number of nodes greater than x in a given tree: ");
		int x = scanner.nextInt();
		TreeNode<Integer> root = takeInputLevelWise();
		System.out.printf("%d nodes are greater than %d in the given tree. %n", numNodeGreater(root, x), x);
	}
